  ...
  const blogs = [
    {
      id: 1,
      title:
        "Great experience getting my problem with lost and corrupt Excel files solved.",
      image: "/src/assets/blog1.png",
    },
    {
      id: 2,
      title:
        "The service is always excellent  a great attentive staff.  Thank You for your service.",
      image: "/src/assets/blog2.png",
    },
    {
      id: 3,
      title:
        "Excellent in every way. Very good communications. Fair prices. Quick work.",
    ...
    <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto my-12" id="faq">
      ...
      >
        ...
        <p className="text-sm text-neutralGrey mb-8 md:w-3/4 mx-auto">
          Customers appreciate the laptops superior build quality, likening it
          to a premium device, and they also value our rental service and gaming
          options, although opinions vary on the laptops value, performance,
          and appearance.
        </p>
      </motion.div>
