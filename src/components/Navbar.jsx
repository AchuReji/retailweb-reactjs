  ...
  return (
    <header className=" bg-white md:bg-transparent fixed top-0 left-0 right-0">
      <nav className={`py-4 lg:px-14 px-4 ${
        ...
        <div className="flex justify-between items-center text-base gap-1">
          <a href="" className="text-2xl font-semibold flex items-center space-x-0"><img src={logo} alt="" className="w-11 inline-block items-center"/><span>AGATHTRADERS</span></a>
       ...
       <div className="space-x-12 hidden lg:flex items-center">
           ...
           <button  className="bg-brandPrimary text-white  py-2 px-4 transition-all duration-300 rounded hover:bg-neutralDGrey" >Contacts Us</button>
         </div>
